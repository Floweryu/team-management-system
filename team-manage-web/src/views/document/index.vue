  ...
  <div class="user">
    ...
    <el-card class="body">
      ...
      >
        ...
        <el-table-column fixed prop="title" label="文献标题" width="90" align="center" />
        <el-table-column prop="author" label="作者" width="200" align="center" />
        <el-table-column prop="publishTime" label="发表时间" width="80" align="center" />
        <el-table-column prop="introduction" label="文献简介" width="60" align="center" />
        <el-table-column prop="publishPlace" label="出版单位" width="60" align="center" />
        <el-table-column prop="size" label="文献大小" width="60" align="center" />
        <el-table-column prop="uploadUserId" label="上传用户" width="60" align="center" />
        <el-table-column prop="uploadTime" label="上传时间" width="60" align="center" />
        <el-table-column prop="originAddress" label="来源地址" width="60" align="center" />
        ...
        <el-table-column prop="downloadCount" label="下载次数" width="60" align="center" />
        <el-table-column prop="storePath" label="存储位置" width="60" align="center" />
